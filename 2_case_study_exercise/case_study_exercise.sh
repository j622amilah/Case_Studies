...
# -------------------------
# Calculate rand score for the cluster : later
# ***** REDO BELOW *****
# -------------------------
export val=$(echo "X1")
...
# Is each category of [numerical average per span of time] statistically different than the other categories of [numerical average per span of time]?
# ---------------------------------------------
# *** NOT AUTOMATED, but written out *** 
export val=$(echo "X1")
...
# Try 1: More simplistic thinking, no ARRAY 
		...
		# CREATE OR REPLACE TABLE google_analytics_exercise.exercise_full_clean7 AS ( QUERY_HERE );  # Works on console, but not in command script
